...
exports.single = (OrderID) => {
 ...
 exports.addbill =(Order)=>{
    var sql = `INSERT INTO orders(OrderDate, UserID,Tenkhachhang,Address,Total,Phone) VALUES(NOW(),'${Order.userID}','${Order.namekhachhang}','${Order.address}','${Order.total}','${Order.phone}')`;
     return db.save(sql);
...
exports.addbilldetail = detail => {
    var sql = `INSERT INTO orderdetails(OrderID,ProID,TenSanPham,Quantity,Price,Amount) VALUES('${detail.orderId}','${detail.proId}' ,'${detail.proName}' ,  '${detail.quantity}', '${detail.price}','${detail.sum}')`;
    return db.save(sql);
}
