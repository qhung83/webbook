...
router.get('/byCat/:catId', (req, res) => { // view ra các sản phẩm theo mã nhóm tương ứng
...
router.get('/byBrand/:brandId', (req, res) => { // view ra sản phẩm theo thương hiệu tương ứng
...
router.get('/detail/:proID', (req, res) => {  // view ra chi tiết sản phẩm tương ứng với id của sp
